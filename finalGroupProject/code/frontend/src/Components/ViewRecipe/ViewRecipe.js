...
export default function ViewRecipe() {
  ...
  const handleDelete = (recipeId) => {
    axios.delete(`http://localhost:8080/api/recipe/deleteRecipe/${recipeId}`).then((response) => {
            ...
            <Card.Body>
              ...
              <div className="recipe-container">
                <Card.Text>
                  ...
                  <h3 className="card-description-title">Recipe Instructions</h3>
                  <span className="card-description">{recipe.instructions}</span>
                  ...
                  <h3 className="card-description-title">Serves: {recipe.servings}</h3>
                  <h3 className="card-description-title">Preparation Time: {recipe.prepTime}</h3>
                </Card.Text>
        ...
        <Row>
          <Col md={12}>
            ...
            { currentUserEmail === recipe.emailId && (
                  <div>
                    <MDBBtn color="dark" onClick={handleUpdate} style={{ height: "36px", overflow: "visible", marginRight: "20px" }}>
                      Update Recipe
                    </MDBBtn>
                    <MDBBtn color="dark" onClick={(e) => {handleDelete()}} style={{ height: "36px", overflow: "visible", marginLeft: "20px" }}>
                      Delete Recipe
                    </MDBBtn>
                  </div>
                )}
