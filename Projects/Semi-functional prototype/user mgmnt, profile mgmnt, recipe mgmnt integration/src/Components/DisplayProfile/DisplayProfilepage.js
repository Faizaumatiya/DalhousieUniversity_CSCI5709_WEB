                            ...
                            <MDBCardBody className="text-black p-4">
                                ...
                                <MDBRow>
                                    <MDBCol className="mb-2">
                                        <MDBCardImage src="6.jpg"
                                            alt="image 1" className="w-100 rounded-3" />
                                        <div>
                                            <MDBBtn outline color="dark" onClick={deleterecipe} style={{ height: '36px', overflow: 'visible' }}>
                                                Delete
                                            </MDBBtn>&nbsp; &nbsp; &nbsp;
                                            <MDBBtn outline color="dark" onClick={updaterecipe} style={{ height: '36px', overflow: 'visible' }}>
                                                Update
                                            </MDBBtn>
                                        </div>
                                    </MDBCol>
